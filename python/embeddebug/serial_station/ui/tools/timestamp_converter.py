...
class TimestampConverterPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        epoch_row.addWidget(QLabel(self.tr("Epoch:")))
        ...
        fmt_row = QHBoxLayout()
        fmt_row.addWidget(QLabel(self.tr("格式:")))
    ...
    def _build_tz_row(self, root: QVBoxLayout) -> None:
        ...
        lay.setSpacing(6)
        lay.addWidget(QLabel(self.tr("时区:")))
    ...
    def _build_result_box(self) -> QWidget:
        ...
        for key, label in (
            ...
            edit = QLineEdit()
            edit.setObjectName("serialStationTimestampConverterResultEdit")
