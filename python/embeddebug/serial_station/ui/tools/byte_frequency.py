...
class ByteFrequencyAnalyzer(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        _mode_label.setObjectName("serialStationByteFreqInputModeLabel")
        mode_row.addWidget(_mode_label)
        self._mode_ascii = QRadioButton(self.tr("ASCII"))
        self._mode_ascii.setObjectName("serialStationByteFreqModeAscii")
        self._mode_hex = QRadioButton(self.tr("Hex"))
        self._mode_hex.setObjectName("serialStationByteFreqModeHex")
