...
| R-10 | EXE 便捷分发 | conditional | PyInstaller 6.22.0 lock、`packaging/build.ps1`/`package.ps1`/`sign-build.ps1`/`verify-signature.ps1`/`verify-upgrade-rollback.ps1`、ADR-082/087/089/090/091/092/093、v13 EXE/ZIP SHA-256、包 manifest/verifier、隔离 `/login`/`ready`/v13 资源 200、真实记录重启读取和 v12→v13→v12 数据保留证据 | 批准的 Authenticode 证书/SignTool/时间戳服务和正式分发 |
