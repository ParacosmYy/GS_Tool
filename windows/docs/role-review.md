...
| 角色 | 关注点 | 结果 | 证据与遗留风险 |
|---|---|---|---|
| UI-1 视觉系统 | Material 3 语义 token、Moonshot-inspired 黑底大排版、首屏/图表/表单/空状态一致性 | 通过 | `docs/design-tokens.md`、`style.css`、`ui-polish.css`、`scene-motion.css`；v10 工作站背景、v10 可见度调校、显式图像场景层、认证玻璃卡片和 RUST/RL 场景签名已落地，v9/v8 仍保留为回滚资产；合成边界见 ADR-057/065/070/074/076。 |
