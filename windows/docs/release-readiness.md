...
| Android APK | pending | 版本契约已固定为 AGP 9.3.0 / Gradle 9.5.0 / JDK 17 / API 37 / Compose BOM 2026.06.00；Android v11 背景与 SignalOrbit 已接入系统减少动画边界（ADR-079/080），`android/toolchain-doctor.ps1` 仍等待实际 JDK、Wrapper、SDK 和 APK 验收 |
