...
| EXE | conditional | PyInstaller 6.22.0 已锁定并按 v12 资源重建 onedir EXE/ZIP；隔离 `/login`、v12 资源、`/api/v1/ready`、真实记录写入/重启读取、包 manifest/hash verifier 和 `%LOCALAPPDATA%` 建库已通过（ADR-082/087/089）；真实升级/回滚、签名和正式分发仍待验收 |
