...
| Web UI-3 | in progress | 登录页四档观察、隔离合法会话下 Dashboard/Admin 空态、动态错误 alert/status 播报、四档 viewport/焦点回流、历史非空、服务端 CSV 200 和 Provider 502 错误态已有证据；真实设备指标、浏览器下载落盘、真实 Provider 成功、reduced-motion/高对比度环境仍待证据 |
