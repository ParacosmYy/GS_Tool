...
以下六个目录从 [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) 的 `skills/` 目录安装，快照日期为 2026-08-10。它们是项目资料，不是全局 Codex 配置；后续升级必须显式记录来源 commit/ref、变更摘要和影响面。
