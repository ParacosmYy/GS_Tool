...
def _check_contract_references(root: Path, checks: list[AuditCheck]) -> None:
    ...
    references = (
        ...
        ("exe-build-decision", "windows/docs/decisions/ADR-087-exe-v12-rebuild-evidence.md", "4B8C52BC393CFD7F7D6D3530A6C028EA3949DC3C13BFF28AF3ECCEAD38651DCE"),
        ("exe-package-evidence", "windows/docs/decisions/ADR-087-exe-v12-rebuild-evidence.md", "5A8E05660A692FB82F0F3EE9636D2D902B6A53CBECE597B0E705BB0FA23049BE"),
