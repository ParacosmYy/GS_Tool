...
public:
    ...
    /** @brief 获取累计Critical级别通知数 @return Critical通知次数 */
    quint64 totalCriticalNotifications() const { return m_totalCriticalNotifications; }
    /** @brief 获取累计High级别通知数 @return High通知次数 */
