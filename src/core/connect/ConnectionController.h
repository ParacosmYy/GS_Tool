...
public:
    ...
    quint64 totalErrors() const;             ///< 累计连接错误次数
    quint64 errorCount() const;              ///< 累计连接错误次数(同totalErrors)
