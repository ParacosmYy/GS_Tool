...
quint64 SettingsManager::totalReads() const
{
    return m_totalReads;
}

/** @brief 获取配置写入总次数 @return 写入操作总次数 */
quint64 SettingsManager::totalWrites() const
{
    return m_totalWrites;
}

/** @brief 获取配置删除总次数 @return 删除操作总次数 */
quint64 SettingsManager::totalRemoves() const
{
    return m_totalRemoves;
}

/** @brief 获取配置操作错误总次数 @return 错误次数 */
quint64 SettingsManager::errorCount() const
{
    return m_errorCount;
}
