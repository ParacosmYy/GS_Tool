...
private:
    ...
    QVector<int> gfPolyMul(const QVector<int>& a, const QVector<int>& b);
    QVector<int> gfPolyDiv(const QVector<int>& a, const QVector<int>& b);
