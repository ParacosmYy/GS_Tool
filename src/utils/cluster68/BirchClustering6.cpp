...
#include "utils/cluster68/BirchClustering6.h"
 ...
 */
void BirchClustering6::setThreshold(double t)
{
 ...
 * @param b 每个节点最大的子簇数量
 */
void BirchClustering6::setBranchFactor(int b)
{
 ...
 * @return 每个点的聚类标签
 */
QVector<int> BirchClustering6::cluster(const QVector<QVector<double>>& points)
{
    QElapsedTimer timer;
    timer.start();
