 ...
 * @brief 实时波形图控件实现 — 构造函数、UI初始化与工具栏
 *
 * 实现要点: 构造连接信号 / 主题切换更新视觉 / ChartColors主题调色板 / 数据线颜色随主题变化
 *
 * 槽函数与公开接口见 ChartWidgetSlots.cpp
 * 导出/快照/统计接口见 ChartWidgetExport.cpp
 * 主题切换/Series管理见 ChartWidgetTheme.cpp
 * 数据渲染/通道同步见 ChartWidgetRender.cpp
 */
