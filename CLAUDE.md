...
| 当前版本 | 0.1.0 |
| 评分 | 797（见 [docs/tracking/SCORE_TRACKING.md](docs/tracking/SCORE_TRACKING.md)） |
| Git分支 | `feat/embed-debug` |
| Git远程 | `https://github.com/ParacosmYy/GS_Tool.git` |
| 测试文件数 | 185（Batch 128/129 新增 qss_sections_widgets_states + search 扩展） |
| 测试通过 | 2358 passed, 2 skipped, 0 failed |
