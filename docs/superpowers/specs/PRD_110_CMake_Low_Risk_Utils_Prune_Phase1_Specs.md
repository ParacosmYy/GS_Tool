...
- 从主 GUI 目标 CMake 清单中移除 6 个低风险 active utils 候选目录。
- 保留源码，不删除、不移动。
...
| 文档 | `docs/prd/PRD_110_CMake_Low_Risk_Utils_Prune_Phase1.md` | 新增 |
| 文档 | `docs/superpowers/specs/PRD_110_CMake_Low_Risk_Utils_Prune_Phase1_Specs.md` | 新增 |
...
| commit | 随本轮 `CMake: 移除首批低风险utils候选` 提交记录 |
