...
- 从主 GUI 目标 CMake 清单中移除第二批低风险 active utils 候选目录。
- 保留源码，不删除、不移动。
...
| 文档 | `docs/prd/PRD_111_CMake_Low_Risk_Utils_Prune_Phase2.md` | 新增 |
| 文档 | `docs/superpowers/specs/PRD_111_CMake_Low_Risk_Utils_Prune_Phase2_Specs.md` | 新增 |
...
| commit | 随本轮 `CMake: 移除第二批低风险utils候选` 提交记录 |
