...
| 评分进度 | `560 / 1000` | `docs/tracking/SCORE_TRACKING.md` |
...
| Serial Station | UART/TCP 主流程可用，连接、断开、刷新端口、发送和 Fake RX 注入失败可诊断 | `python/embeddebug/serial_station/ui/connection_actions.py` |
