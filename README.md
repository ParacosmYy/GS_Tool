...
| 评分进度 | `567 / 1000` | `docs/tracking/SCORE_TRACKING.md` |
...
| Serial Station | UART/TCP 主流程可用，连接状态、断开、刷新端口、发送、快捷键、命令历史、Profile 恢复和错误状态反馈可诊断 | `python/embeddebug/serial_station/ui/status_actions.py` |
