...
|------|--------------------|
| Serial Station | Independent `src/apps/serial_station/` workbench with UART config, command panel, structured logs, log export, replay preview, status bar, send/receive loop, dispatcher, codec, and protocol registry |
...
- central Serial Station workbench for port setup, protocol mode, command send, structured logs, export/replay preview, and status;
