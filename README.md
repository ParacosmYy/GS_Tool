...
| 评分进度 | `607 / 1000` | `docs/tracking/SCORE_TRACKING.md` |
...
当前 controller 已将测量缓冲、命令历史、日志状态和连接日志等内部状态拆成小 helper，UI 主布局已将连接工具栏拆出独立 helper，保持主编排文件低于 300 行，后续功能增量必须继续维持这个边界。
