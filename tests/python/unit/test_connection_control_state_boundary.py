...
class _SimpleHost:
    def __init__(self) -> None:
        self._connect_button = _Button()
        self._connect_serial_button = _Button()
        self._connect_tcp_button = _Button()
        self._connect_udp_button = _Button()
        self._disconnect_button = _Button()
