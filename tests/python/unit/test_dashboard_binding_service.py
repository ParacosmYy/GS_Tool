...
def test_parse_channel_kind_rejects_invalid_channel():
...
def test_parse_slider_rejects_invalid_parts():
...
def test_parse_button_command():
    ...
    spaced = parse_binding_spec("button:SET VOLTAGE 5")
    assert spaced is not None
    assert spaced.command == "SET VOLTAGE 5"
def test_parse_invalid_specs_return_none():
...
def test_is_valid_spec_boolean_wrapper():
...
def test_default_spec_for_widget_types():
